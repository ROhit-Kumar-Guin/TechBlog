...
const Login = () => {
  ...
  return (
    <>
    <div className="flex items-center justify-between px-6 md:px-[200px] py-4 bg-[#1b0043]">
    <h1 className="text-lg md:text-xl font-extrabold text-white"><Link to="/">TechBloggy</Link></h1>
...
<div className="w-full flex justify-center items-center h-[80vh] ">
       <div className="flex flex-col justify-center items-center space-y-4 w-[80%] md:w-[25%]">
         ...
         <div className="flex justify-center items-center space-x-3">
          <p>New here?</p>
          <p className="text-white hover:text-gray "><Link to="/register">Register</Link></p>
         </div>
       </div>
    </div>
    <Footer/>
