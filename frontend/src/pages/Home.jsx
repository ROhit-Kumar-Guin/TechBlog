  ...
  return (
    <div>
      ...
      <div className='flex flex-wrap'>
        <div className='p-3 m-5 flex-wrap justify-center '>

          {
            cat.length && cat?.map((category) => {
              return <button className='p-3 m-5 h-[90px] w-[150px] border text-lg font-semibold bg-white hover:shadow-blue-200 shadow shadow-black' onClick={() => fillterData(category)}>
                {category}
              </button>
            })
          }
