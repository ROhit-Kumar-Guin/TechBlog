...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between px-6 md:px-[200px] py-4 bg-[#1b0043] text-white  ">
    <h1 className="text-lg md:text-xl font-extrabold"><Link to="/">TechBloggy </Link></h1>
